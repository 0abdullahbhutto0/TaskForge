    ...
    <!--<main style="background-image: url({{ Vite::asset('resources/images/bg-image.png') }})" class="relative min-h-screen bg-no-repeat bg-center bg-cover">-->
        <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="flex justify-center items-center space-x-4 mb-12">
                <img src="{{ Vite::asset('resources/images/hero-image.png') }}" alt="Hero Illustrations"
                    style="width: 500px; height: 85px">
            </div>

            <div class="text-center">
                <h1
                    class="text-4xl font-bold tracking-tight text-foreground sm:text-5xl md:text-6xl lg:text-7xl text-balance">
