<x-layout>
    <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div class="flex justify-center items-center space-x-4 mb-12">
            <img src="{{ asset('images/hero-image.png') }}" alt="Hero Illustrations" style="width: 500px; height: 85px">
        </div>

        <div class="text-center">
            <h1 class="text-4xl font-bold tracking-tight text-foreground sm:text-5xl md:text-6xl lg:text-7xl text-balance">
                <span class="text-gray-900">Streamline tasks.</span>
                <br>
                <span class="text-blue-600">Empower teams.</span>
            </h1>

            <p class="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground md:text-xl text-balance">
            ...
            <div class="mt-10 flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4 mb-8">
                <a href="/register"
                    class=" bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 transition flex items-center space-x-2">
                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="border-b border-gray-200">
                                <th class="text-left py-3 px-4 text-sm font-semibold text-gray-600">PROJECT NAME</th>
    ...
    <section id="features" class="bg-white py-20">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Built for clarity and accountability</h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Every role has distinct permissions. Every task has clear ownership. Overseer brings order to your
                    workflow.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 rounded-xl p-8">
                    ...
                    <p class="text-gray-600">
                        Create and delegate tasks with priority levels, deadlines, and real-time team progress tracking.
                    </p>
                </div>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white rounded-2xl p-8 shadow-sm">
                    ...
                    <p class="text-gray-600 mb-6">Manage users, assign roles, and oversee system-wide operations</p>
                    <ul class="space-y-3">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm relative">
                    ...
                    <p class="text-gray-600 mb-6">Lead your team with powerful task creation and delegation tools</p>
                    <ul class="space-y-3">
                        <li class="flex items-start">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm relative">
                    ...
                    <p class="text-gray-600 mb-6">Focus on what matters with a clear view of your responsibilities</p>
                    <ul class="space-y-3">
                        <li class="flex items-start">
    ...
    <section class="bg-[#0F172A] py-24 px-4">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <p class="text-lg text-blue-200/80 mb-10 max-w-2xl mx-auto leading-relaxed">
                Join teams who trust TaskForge to bring clarity to their task management. Start free and scale as you
                grow.
            </p>
