@props(['active' => false])
<a {{ $attributes->merge(['class'=>'{{ $active ? 'bg-gray-700 text-gray-100' : 'text-gray-600 hover:bg-gray-400 hover:text-black' }} is-drawer-close:tooltip is-drawer-close:tooltip-right']) }} data-tip="{{ $slot }}" href="/invites" {{ $attributes }}>
    <!-- Settings icon -->
